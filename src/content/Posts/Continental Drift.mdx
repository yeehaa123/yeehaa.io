...
- blog
draft: false
excerpt: Internet fragmentation is often framed and lamented from a Western perspective. This narrative, however, sadly misses all the departures and detours that the web has taken in different parts of the world. By valuing these divergences and their resulting different digital landscapes, the limitations of a one-size-fits-all internet model can be overcome. Fragmentation then opens up a pathway to a more connected and aligned global community.
