...
Let's stay in the warm and foamy jacuzy, while increasing our awareness of its inherent problems. The two most undesirable side effects of filter bubbles are the following:
...
**Solipsism**: This is a condition where you truly believing that your bubble is the only (true) one. If you are too enamored by your community's values, you are bound to overlook its limitations and problems. Every ecosystem is defined by boundaries. A bubble that is good for you can be stifling, or even harmful, to someone else.

From now onwards, the challenge lies in solve these problems without reentering the arena of universal values and norms. As soon as we start bursting bubbles again — either that of someone else or our own — foam reveals its most important characteristic: it has no outside. There is no bird's eye point of view. The outside of a bubble is another bubble. As soon as we truly accept this existential fact, we stop bursting bubbles and begin to foster ecosystems: both internally and externally. 

## We Go HAM

We must develop rituals and practices that facilitate and ease alignment within and between different ecosystems. [Decentralization](https://medium.com/nakamo-to/whats-the-difference-between-decentralized-and-distributed-1b8de5e7f5a4) is the umbrella term to cover a multiplicity of cultural techniques that can be employed to achieve this. Despite what crypto-boys and girls (who are we kidding, they are all boys) try to make us believe, blockchain, bitcoin, and DAO's are far from the first or the best examples of decentralization. The feudal system, silk road, and the Greek city states were all build around principles of distributed power and organization. 

In the technical realm, however, the prototypical example of decentralization is Ham radio. This technology and its community are marked by the following principles:
