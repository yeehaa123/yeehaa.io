...
In his revelatory works *The Gutenberg Galaxy* (1962) and *Understanding Media*, Marshall McLuhan already predicted that connecting the world through technology would not lead to further unification. Instead, he argued that the connective powers of electricity, and the technical media built on top of it, would turn the world into a [global village](https://medium.com/@maiken_louise/mcluhan-s-global-village-still-relevant-today-1bd4e3792b61).

As information travels rapidly across the globe, traditional distinctions between local and global, as well as between different cultures, are eroded. The concept of global village designates a compression of space and time, creating a sense of simultaneous existence for people worldwide. 
...
Paradoxically, while the implosion of time and space effaces some differences, it accentuates and heightens others. McLuhan warns that the omnipresence of technical media will lead to a new age of tribalism. The global village not only homogenizes, it also increases the clashes between different factions, representing diverse cultural, political, or social perspectives. It is thus not far-fetched to say that the term global *village* also hints at the narrow mindedness of its inhabitants.

Looking at the state of the internet today, it is safe to say that McLuhan was not far off with his predictions. The web is akin to a bustling village, where on a multitude of tribes claim and defend the superiority of their own truths and values, while disqualifying and ridiculing those of others. Still, these clashes go far beyond content alone though. In *Gramophone, Film, Typewriter* Friedrich Kittler aptly frames the essence of this conflict as a profound struggle for control over the conduits that transmit words, sounds, and images. In his perspective, content is a form of entertainment thinly disguised as informational fodder. [Bread and circuses](https://en.wikipedia.org/wiki/Bread_and_circuses) provide a captivating backdrop to the overarching battle for dominion over the channels of communication. The internet has become a dynamic arena where factions compete for power not only in the realm of ideas but also in the infrastructure that shapes the very nature of discourse.
...
Through decentralization, the Shanzhai have created a vibrant ecosystem that is capable of iterating and innovating at an incredible speed, while at the same time being more resilient than most other ecosystems. However, the accelerated pace of production and the constant evolution of electronic devices within the Shanzhai ecosystem also results in tons and tons waste. The disposability of outdated components, prototypes, and devices can lead to ecological concerns, necessitating a careful examination of sustainable practices within the Shanzhai manufacturing landscape. As the Shanzhai model continues to shape the technological landscape, it becomes imperative to balance its innovative strengths with environmental considerations, fostering a more sustainable approach to manufacturing and electronic waste management.

## Garb-Age

Decentralization is not fragmentation. On the contrary, its practices can be used not only reduce and heal the painful effects of foaming, but also to make the bubbles more vibrant and resilient than ever before. It is exactly in this respect that the practice of decentralization has a lot of overlap with that of regeneration. Regenerative design is an approach to designing systems, whether they are natural ecosystems, buildings, or communities, with the goal of improving the environment and society it interacts with. This emerging discipline encompasses a variety of cultural techniques that we can use as inspiration:
