...
Attempts to pop these filter bubbles confronts us with foam's most important characteristic: it has no outside, there is no bird's eye point of view. The outside of a bubble is another bubble. As soon as we have truly accepted this existential fact, the challenge is no longer to pop bubbles but to align them: both internally and externally. 
