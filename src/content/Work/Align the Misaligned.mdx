...
The privilege to hop from bubble to bubble is not to be taken lightly. Voting with your feet is an essential condition for creativity and innovation. The possibility of another habitat beyond the one that you are currently in, is a necessary condition to imagine, design, develop, and maintain new and better ecosystems. This phenomenon is off all ages. As Walter Benjamin showed throughout his work, the history of utopianism and that of architecture are one and the same. Architecture is yesterday's projection of how future ecosystems could look like. And in the age of the internet, this projection exceeds mere physical bricks and mortar.
...
As a collective dream, the OG internet was the last refuge of modernism. It was imagined as a huge cathedral where everyone was welcome and that we were building collectively. But this virtual Sacrada Familia came with one major catch. You had to convert to the shared belief system upon entrance. Letting go of that pressure of universal consensus should not lead to mourning, but should be welcomed with a sigh of relief. Once we affirm value pluralism, the decentralized internet opens up affordances that go beyond modernisms wildest dreams. It allows us to create ecosystems that defy spatial and temporal boundaries altogether. 
