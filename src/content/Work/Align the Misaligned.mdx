...
Looking at the contemporary internet, it is safe to say that McLuhan was not far off with his predictions. A multitude of tribes are claiming and defending the superiority of their own truths and values, while disqualifying and ridiculing those of others. Still, these clashes go far beyond content alone though.  Friedrich Kittler aptly frames the essence of this conflict as a profound struggle for control over the conduits that transmit words, sounds, and images. In his perspective, content not only serves as informational fodder but mainly as a form of entertainment. [Bread and circuses](https://en.wikipedia.org/wiki/Bread_and_circuses) provide a captivating backdrop to the overarching battle for dominion over the channels of communication. The internet has become a dynamic arena where factions compete for power not only in the realm of ideas but also in the infrastructure that shapes the very nature of discourse.
