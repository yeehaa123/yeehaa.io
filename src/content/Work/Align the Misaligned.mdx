...
When perceived through the lens of abundance, decentralized ecosystems have the potential to be more vibrant and resilient than any centralized community or organization ever was. By giving communities more control over their resources and decision-making processes, they become increasingly empowered to collaboratively create healthier ecosystems. It is exactly in this north star vision where the practices of decentralization and regeneration meet. 
...
Regeneration is an approach to designing systems. The scope of this practice is very broad. It ranges from physical spaces such as natural ecosystems, towns, and buildings, to more abstract ones like communities, initiatives, and ventures. What defines this practice in all these different contexts is the underlying goal: to improve the environment and society its designed spaces interact with. To accomplish this, regenerative design encompasses a wide variety of cultural techniques. For current purposes I will focus on the following two:
...
While different in scope,activity, and outcomes, permaculture and biomimicry share a deep desire to learn from nature. Whereas modern natural sciences are aimed at predicting, controlling, and exploiting the biosphere, these contemporary alternatives try to avoid such hierarchical power relations. Their stance towards nature is better understood as a dialogue: they listen and talk to it. This conversational relation does not limit itself to nature in the strict sense of the word: it extends to culture, the past, and everything else. Regeneration is first and foremost a practice of alignment. But in order to align, one first has to learn to truly listen.

What can we learn from ecosystems? In *Designing Regenerative Cultures* (2016), Daniel Christian Wahl  argues that their
