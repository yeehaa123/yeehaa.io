...
Decentralization is not fragmentation. When applied correctly, its cultural techniques can actually smoothen and alleviate the painful effects of foaming. The problem with its most emblematic, contemporary manifestation is that its community got mesmerized by an excess mindset. The original hype around the endless possibilities of blockchain's immutable and incorruptible ledger, was entirely replaced by crypto's everyone can get rich instantly pyramid scheme. But crypto is not blockchain and blockchain is not decentralization.

But it is too easy to blame the excess mindset entirely on capitalism. As Walter Benjamin most poignantly pointed out in *The Work of Art in the Age of Mechanical Reproduction*, the technical affordances of an era define its ideological affordances just as much as vice versa. If modern capitalism relies on extraction and waste production, it is only because that it has means of production at its disposal that facilitate it. 
...
Benjamin frames modernity as the process that eliminates physical and temporal scarcity as the limiting factor of humanities progress. Cameras — even analogue ones — can capture a portrait in the same amount of time that it takes a painter to blink his eyes. And while his painting is unique, the camera's snapshot can be reproduced infinitely. It is literally the 10x mindset before any venture capitalist even existed.

The early days of the internet For the first time in modern history, the age of electronic reproduction presented us with a core resource that, at least at first glance, is not bound by scarcity: information.

But scarcity is not only the guiding principle of our economy, it is also the concept that structure its theory. It is thus not a coincidence that at the same time as Benjamin started exploring how an economy would function without scarcity, his close friend and accomplish Georges Bataille started developing the concept of an economy of excess.
