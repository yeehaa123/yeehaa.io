...
Crypto's rise marked a short resurgence of a mirage that ruled the end of the last millenium. The 1990 held a sincere believe that capitalism and liberalism had solved all problems, and history was close to completion. Excess, and its antipode scarcity, played a crucial role in that narrative. Cold fusion was going to provide is with an inexhaustible source of energy, and the internet opened up a new with virtual space that revolved around an boundless resource: information. And in such a world, world peace was just around the corner. Then the dotcom bubble bursted, the twin towers were bombed, and the inconvenient truth of climate change became slowly apparent. 
...
Benjamin frames modernity as the process that eliminates physical and temporal scarcity as the limiting factor of humanity's progress. Cameras — even analogue ones — can capture a portrait in the same amount of time that it takes a painter to blink his eyes. And while his painting is unique, the camera's snapshot can be reproduced infinitely. Technical innovation was determined by the 10x mindset long before any venture capitalist ever existed. A resource that never runs out would be its ultimate manifestation.

But scarcity is not just the central principle of our economy, it is also the guiding concept that structures the entire discipline and its history. It is thus not a coincidence that at the same time as Benjamin examined how the world would (stop to) function without scarcity, his close friend and accomplish Georges Bataille developed the concept of an economy of excess.
