...
The early internet marks a short break in Until the dotcom bubble bursted, is not bound by scarcity: information.

But scarcity is not only the central principle of our economy, it is also the guiding concept that structure the entire discipline and its history. It is thus not a coincidence that at the same time as Benjamin started exploring how an economy would function without scarcity, his close friend and accomplish Georges Bataille started developing the concept of an economy of excess.
