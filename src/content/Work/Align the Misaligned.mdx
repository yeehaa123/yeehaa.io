...
**Solipsism**: Truly believing your bubble is the only one. If you are strongly attracted to your community's values, it can lead to overlooking the limitations and problems within your bubble. However, every community is defined by boundaries. A bubble that is good for you can be stifling or even harmful to someone else.

Today's challenge is to solve these problems without reentering the arena of universal values and norms. As soon as we start bursting bubbles again — either that of someone else or our own — foam reveals its most important characteristic. Foam has no outside, there is no bird's eye point of view. The outside of a bubble is another bubble. As soon as we have truly accepted this existential fact, the challenge is no longer to burst bubbles but to foster ecosystems: both internally and externally. 

## We Go HAM

We must develop rituals and practices that facilitate and ease alignment within and between different ecosystems. [Decentralization](https://medium.com/nakamo-to/whats-the-difference-between-decentralized-and-distributed-1b8de5e7f5a4) is the umbrella term to cover a multiplicity of cultural techniques that can be employed to achieve this. Despite what crypto-boys and girls (who am I kidding, they are all boys) try to make us believe, blockchain, bitcoin, and DAO's are far from the first or the best examples of decentralization. The feudal system, silk road, and the Greek city states were all build around principles of distributed power and organization. 
