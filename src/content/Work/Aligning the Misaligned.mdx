...
Having the freedom to choose between multiple ecosystems is a decisive argument against the claim that fragmentation is just loss. In fact, it is an affordance that the OG internet can never offer, since universality makes reality all-encompassing and inescapable. In order to prevent this, there needs to be an out, there needs to be multiplicity, there needs to be foaming. The possibility to switch your habitat is nature's antidote to entrapment and solipsism. 

The privilege to hop from bubble to bubble is not to be taken lightly. Voting with your feet is an essential condition for creativity and innovation. Imagination demands the possibility of another habitat. It is a necessary condition to dream, design, develop, and maintain new and better ecosystems. This phenomenon is off all ages. As Walter Benjamin showed throughout his work, the history of utopianism and that of architecture are one and the same. Architecture is yesterday's projection of how tomorrow's ecosystems should look like. And in the age of the internet, this projection exceeds mere physical bricks and mortar.
...
As a collective dream, the OG internet is the last refuge of modernism. It is imagined as a huge cathedral that we are building collectively. Everyone is welcome to join and contribute. But this virtual Sacrada Familia comes with one major catch. You have to convert to the shared belief system upon entrance. The dream is only appealing to those that are already converted.

As argued earlier, letting go of that pressure of universal values should not lead to mourning, but be welcomed with a sigh of relief. Once we affirm and celebrate value pluralism, the decentralized internet will open up realms that go beyond modernisms wildest dreams. It allows us to create spaces that completely defy spatial and temporal boundaries altogether.

Balaji Srinivan's *The Network State*, may be this new era paradigm first philosophical masterpiece.
