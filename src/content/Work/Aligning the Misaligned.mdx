...
As a collective dream, the OG internet is the last refuge of modernism. Caught in an architectural metaphor, it is best imagined as a huge cathedral that the entire world is building together. Everyone is welcome to join and contribute to this virtual Sacrada Familia. There is on major catch though. You have to convert to the shared belief system upon entrance. What those on the inside do not realize, however, is that their values are not universal or even universally appealing. Their dream only attracts those that are already converted.

As mentioned earlier, letting go of that pressure of globally shared values should not lead to mourning, but be welcomed with a deep sigh of relief. Once we affirm and celebrate value pluralism, the internet will open up realms that go beyond modernism's wildest dreams. To unite the whole world under one roof was never its true promise. From its inception, it blew up that roof altogether. Understood as foam, the decentralized internet truly enables the creation of spaces that completely defy spatial and temporal boundaries altogether.

Balaji Srinivan's *The Network State*, may be this new era paradigm first philosophical masterpiece. Its claim is deceivingly simple: the era of the nation state is about to be replaced by the network state. In Srinivan's view, states will be no longer need to be defined by their claim on contiguous physical space. The internet has removed the necessity for that requirement:
...
Freed from the scarcity of physical space, it becomes much easier for communities of values to coexist with one another. Moreover, their members will no longer be restricted to inhabit a single ecosystem at the time. In the age of foam, they can be citizens of many different ones, even multiple at once. I believe that, moving forward, the pressure on existing and new ecosystems to facilitate this basic desire of their citizens will only increase.

## Ecosystem Architecture

Future ecosystems should be designed around the right of people to vote with their feet feet. Their values should thus be validated.... More than ever before, we have the possibility to create intentional ecosystems driven by values instead of random communities created by temporal-spatio contingency.
